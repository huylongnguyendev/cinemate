  ...
  return (
    <>
      <div
        ref={ref}
        className={cn(
          "absolute top-0 lg:top-5.5 max-lg:left-0 lg:right-17 2xl:right-29 w-0 max-lg:p-4 bg-background rounded-md inline-flex justify-center items-center z-50 max-lg:shadow-lg shadow-muted opacity-0 invisible overflow-hidden",
